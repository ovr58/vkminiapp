...
// See https://ai.google.dev/gemini-api/docs/safety-settings
    history: [
    {
        role: "user",
        parts: [
        {text: "напиши сказку для детей 3-8 лет, содержащую  пять глав, образовательного характера, к каждой главе нужно сгенерировать промт соответствующей иллюстрации, а также сгенерировать промт для обложки книги, все в paper cut style, история должна быть про мальчика который поехал учиться в магическую школу, его имя Иван, все происходит в России и главный герой переживает приключения, в которых узнает много интересного о науке и природе, его друзьями становятся разные персонажи из русских сказок, сюжет должен быть не сложным, но последовательным и заканчиваться все должно хорошо результат должен быть представлен в JSON\n"},
        ],
    },
    {
        role: "model",
